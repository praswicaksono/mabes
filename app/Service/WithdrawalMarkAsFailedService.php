...
class WithdrawalMarkAsFailedService
{
    /**
    ...
    {
        if (! $command instanceof WithdrawalMarkAsFailedCommand) {
        ...
        $withdrawal->setStatus(Withdrawal::STATUS_FAILED);
        ...
        $this->event_emitter->emit("admin.withdrawal.failed", [$data]);
